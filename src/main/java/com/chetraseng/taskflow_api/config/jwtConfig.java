...
public class jwtConfig {
    ...
    public KeyPair accessTokenPair() throws NoSuchAlgorithmException {
        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance("RSA");
        keyPairGenerator.initialize(2048);
        return keyPairGenerator.generateKeyPair();
    }

    @Bean(name = "accessTokenRSAKey")
    public RSAKey accessTokenRSAKey(@Qualifier("accessTokenPair") KeyPair keyPair) {
